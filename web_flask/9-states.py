...
def states():
    ...
    Retrieves all states from the storage and sorts them alphabetically by name.
...
def state(state_id):
    ...
    If the state is found, renders a HTML template that displays the state name
    and its associated cities. If the state is not found, returns a "Not found!"
    message.
    """
